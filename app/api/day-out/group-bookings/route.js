        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, DayOut_1.GroupBooking.find(query_1)
                            .populate('packageId', 'name price pricePerPerson')
                            .populate('customerId', 'name email phone')
                            .sort({ bookingDate: -1 })];
                case 2:
                    bookings = _a.sent();
                    fallbackBookings = (0, sampleData_1.withPopulatedRelations)(sampleData_1.sampleGroupBookings, {
                        packageId: sampleData_1.sampleDayOutPackages,
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var body, packageId, customerId, groupName, bookingDate, numberOfPeople, contactPerson, specialRequests, advanceAmount, paymentMethod, dayOutPackage, totalPrice, depositAmount, balanceAmount, booking, populated, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 6, , 7]);
                ...
                case 2:
                    body = _a.sent();
                    packageId = body.packageId, customerId = body.customerId, groupName = body.groupName, bookingDate = body.bookingDate, numberOfPeople = body.numberOfPeople, contactPerson = body.contactPerson, specialRequests = body.specialRequests, advanceAmount = body.advanceAmount, paymentMethod = body.paymentMethod;
                    ...
                    return [4 /*yield*/, DayOut_1.DayOutPackage.findById(packageId)];
                case 3:
                    dayOutPackage = _a.sent();
                    if (!dayOutPackage) {
                        return [2 /*return*/, server_1.NextResponse.json({ success: false, error: 'Package not found' }, { status: 404 })];
                    }
                    if (numberOfPeople > dayOutPackage.maxGroupSize) {
                        return [2 /*return*/, server_1.NextResponse.json({ success: false, error: 'Group size exceeds package capacity' }, { status: 400 })];
                    }
                    totalPrice = numberOfPeople * dayOutPackage.pricePerPerson;
                    ...
                    booking = new DayOut_1.GroupBooking({
                        packageId: packageId,
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, DayOut_1.GroupBooking.findById(id)];
                case 3:
                    booking = _e.sent();
                    if (!booking) {
                ...
                case 20:
                    _e.sent();
                    return [2 /*return*/, server_1.NextResponse.json({ success: true, data: booking })];
                case 21: return [4 /*yield*/, DayOut_1.GroupBooking.findByIdAndUpdate(id, __assign(__assign({}, updateData), { updatedAt: new Date() }), { new: true })];
                case 22:
                    updated = _e.sent();
                    if (!updated) {
                        return [2 /*return*/, server_1.NextResponse.json({ success: false, error: 'Booking not found' }, { status: 404 })];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, DayOut_1.GroupBooking.findByIdAndDelete(id)];
                case 2:
                    _a.sent();
                    return [2 /*return*/, server_1.NextResponse.json({ success: true, message: 'Group booking deleted' })];
                case 3:
                    error_4 = _a.sent();
